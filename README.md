...
| `--ref-or-type <reference|from-type>` | Select genomes used for the initial RefSeq-based ANI screening: RefSeq reference genomes (`reference`, default) or genomes assembled from nomenclatural type material (`from-type`) |
